...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        timer_label.config(text="Long Break Time", fg="White")
    elif reps % 2 == 0:
        timer_label.config(text="Short Break Time", fg="White")
...
text_canvas = canvas.create_text(100, 130, text="00:00", fill="White", font=(FONT_NAME, 40, "bold"))
